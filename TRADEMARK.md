# FCast Trademark Policy

FCast is a registered trademark of FUTO. The FCast source code is available under the [MIT License](LICENSE), but the license does not grant rights to use the FCast trademarks. These guidelines explain how third-party projects can use the FCast name and logo while making it clear they are not official FUTO products.
...
If you are unsure whether your use of the FCast name or logo is appropriate, feel free to ask on the [FCast channel](https://chat.futo.org/#narrow/channel/67-FCast) in the FUTO Chat Zulip server.
