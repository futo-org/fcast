    ...
    private fun createDiscoveryListener(
        ...
        return object : NsdManager.DiscoveryListener {
            ...
            override fun onServiceFound(service: NsdServiceInfo) {
                ...
                // upgrade) and often the addresses are not resolved yet — reporting
                // now would create the device without a fingerprint. Report only
                // from the resolved/updated callbacks below, which carry the TXT.
        ...
        txt["fn"]?.let {
            ...
            val deviceInfo =
                DeviceInfo(friendlyName, ProtocolType.CHROMECAST, addresses, port,
                    txt.mapValues { it.value.decodeToString() })
