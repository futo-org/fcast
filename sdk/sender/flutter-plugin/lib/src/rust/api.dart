...
Future<DeviceInfo?> deviceInfoFromUrl({required String url}) =>
    RustLib.instance.api.crateApiDeviceInfoFromUrl(url: url);
...
class DeviceInfo {
  ...
  @override
  int get hashCode =>
      name.hashCode ^ protocol.hashCode ^ addresses.hashCode ^ port.hashCode;
...
enum ProtocolType { chromecast, fCast }
