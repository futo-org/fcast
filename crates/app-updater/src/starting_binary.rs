// https://github.com/tauri-apps/tauri/blob/3d102e0c136955f20e699835ddfcd004bc0ce799/crates/tauri-utils/src/platform/starting_binary.rs
...
pub struct StartingBinary(std::io::Result<PathBuf>);
...
impl StartingBinary {
    ...
    pub fn cloned(&self) -> Result<PathBuf> {
        // false positive
