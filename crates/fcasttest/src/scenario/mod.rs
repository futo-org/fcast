...
//! fcastplaybin, so nothing here may name it. Tests own the playbin harness
//! (see `crates/fcastplaybin/tests/scenarios.rs`) and use this module for
//! everything that is pipeline-agnostic.
//!
//! ```no_run
