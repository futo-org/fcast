...
//! software-decode arm.
//!
//! This is the android twin of the udmabuf pool `slintvideosink` proposes on
//! linux, and it exists for the same reason. A software decoder writes its pixels with the CPU, so
