...
pub(crate) mod tests {
    ...
    ///
    /// The counting allocator lives in `crate::alloc_counter`; this borrows it,
...
mod pipeline_proof {
    ...
    use fcast_video::{
        cue::CueEngine,
        subpic::{BitmapSubFormat, BitmapPacket},
    };
    use flapjack::{
            ...
            player.set_subtitle_consumer(move |item| match item {
                SubtitleFeedItem::Bitmap {
                    ...
                    engine.submit_bitmap(BitmapPacket {
                        format: match format {
                            flapjack::BitmapSubFormat::Pgs => BitmapSubFormat::Pgs,
                            flapjack::BitmapSubFormat::Vobsub => BitmapSubFormat::Vobsub,
                            flapjack::BitmapSubFormat::Dvb => BitmapSubFormat::Dvb,
                        },
                        data,
                        codec_data,
                        rt,
