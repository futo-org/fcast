...
const GST_ANDROID_URL: &str = "https://gstreamer.freedesktop.org/data/pkg/android/1.26.6/gstreamer-1.0-android-universal-1.26.6.tar.xz";
const GST_ANDROID_AR_PATH: &str = "thirdparty/gstreamer-1.0-android-universal-1.26.6.tar.xz";
/// Always relative to project root
pub const GST_ANDROID_PATH: &str = "thirdparty/gstreamer-1.0-android-universal-1.26.6";
