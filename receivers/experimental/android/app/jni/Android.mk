...
CORE := coreelements coretracers adder app audioconvert audiomixer audiorate audioresample gio pbtypes rawparse typefindfunctions videoconvertscale videorate volume autodetect videofilter insertbin mse switchbin fallbackswitch gopbuffer livesync originalbuffer rstracers streamgrouper threadshare togglerecord
...
CODECS := subparse ogg theora vorbis opus adaptivedemux2 alaw amrnb amrwbdec apetag audioparsers auparse avi flac flv flxdec icydemux id3demux isomp4 matroska mpg123 mulaw multipart png speex taglib vpx wavpack wavparse y4m adpcmdec adpcmenc assrender codecalpha codectimestamper dash dvbsubenc dvbsuboverlay dvdspu hls ivfparse midi openh264 opusparse smoothstreaming videoparsersbad gdp sbc rsaudioparsers dav1d rsclosedcaption ffv1 gif isobmff androidmedia
CODECS_RESTRICTED := mpegpsdemux mpegtsdemux asf dvdsub dvdlpcmdec realmedia libav
